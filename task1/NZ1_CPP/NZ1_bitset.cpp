...
*/
#include "NZ1_bitset.hpp"
#include <fstream>
#include <iostream>

void Bitset::in_console()
{
    Product_st product;
...
void Bitset::viewNotEU()
{
    for (const auto &n: Products)
    {
        if (n.b[PRESENCE] && !n.b[STANDARD])
        {
            ...
            std::cout << "Presence: " << n.b[PRESENCE]  << '\n';
            std::cout << "Standard: " << n.b[STANDARD]  << '\n';
            std::cout << "    Best: " << n.b[BEST]      << std::endl;
        }
    }
}
